...
/**
 * Represents Apple as a {@link Crop} of {@link CropType} Fruit Tree
 */
public class Apple implements Crop {
    private final String codeName = "APL";
    ...
    private final int fertilizerNeeds = 5;
    private final int fertilizerNeedsBonus = 5;

    private final int productsProducedLow = 10;
    private final int productsProducedHigh = 15;

    private final int seedCost = 200;
